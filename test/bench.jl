...
function bench1_p(N::Int)
    m_slave = ModelWithParams(solver = GLPKSolverLP())
...
function bench1_v(N::Int)
    m_slave = Model(solver = GLPKSolverLP())
